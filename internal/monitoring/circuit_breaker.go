...
func (cb *CircuitBreakerBaseRPC) ICYTransferredTo(txHash string, to common.Address) (*big.Int, error) {
	result, err := cb.circuitBreaker.Execute(func() (interface{}, error) {
		return cb.executeWithTimeout("icy_transferred_to", func() (interface{}, error) {
			return cb.wrapped.ICYTransferredTo(txHash, to)
		})
	})
